 ...
 */
public class NTimePickerDialog extends DialogFragment implements
    ...
    public interface OnTimeSetListener {
         ...
         */
        void onTimeSet(NTimePickerDialog view, int hourOfDay, int minute, int second);
    }

    public NTimePickerDialog() {
        // Empty constructor required for dialog fragment.
    }

    public static NTimePickerDialog newInstance(OnTimeSetListener callback,
                                                int hourOfDay, int minute, int second, boolean is24HourMode) {
        NTimePickerDialog ret = new NTimePickerDialog();
    ...
    public static NTimePickerDialog newInstance(OnTimeSetListener callback,
        ...
        return NTimePickerDialog.newInstance(callback, hourOfDay, minute, 0, is24HourMode);
    }

    @SuppressWarnings("unused")
    public static NTimePickerDialog newInstance(OnTimeSetListener callback, boolean is24HourMode) {
        Calendar now = Calendar.getInstance();
        return NTimePickerDialog.newInstance(callback, now.get(Calendar.HOUR_OF_DAY), now.get(Calendar.MINUTE), is24HourMode);
    }
